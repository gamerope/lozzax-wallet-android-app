package io.gamerope.wallet.support.utils;
...
public class SelectorFactory {
    ...
    public static final class GeneralSelector {
        ...
        private boolean hasSetCheckedDrawable = false;
        ...
        public GeneralSelector setCheckedDrawable(Drawable drawable) {
            mCheckedDrawable = drawable;
            hasSetCheckedDrawable = true;
            return this;
        }
        ...
        public StateListDrawable create() {
            ...
            if (hasSetCheckedDrawable)
                selector.addState(new int[]{android.R.attr.state_checked}, mCheckedDrawable);
            if (hasSetFocusedDrawable)
        ...
        //overload
        public GeneralSelector setCheckedDrawable(Context context, @DrawableRes int drawableRes) {
            return setCheckedDrawable(ContextCompat.getDrawable(context, drawableRes));
        }
