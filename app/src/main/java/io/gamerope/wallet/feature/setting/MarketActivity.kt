...
import io.gamerope.wallet.data.entity.Market
            ...
            map?.let {
                if (currentCurrency == map["currency"]) {
                    ...
                    if (xmrPrice.isNullOrBlank()) {
                        ...
                        rate.text = "1 LOZZ ≈ $xmrPrice ${currentCurrency.toUpperCase(Locale.CHINA)}"
                    }
                } else {
                    list.forEach {
                        it.price = ""
