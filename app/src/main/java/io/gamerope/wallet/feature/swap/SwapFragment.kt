...
import io.gamerope.wallet.dialog.ExtraIDPromptDialog
import io.gamerope.wallet.dialog.PickerDialog
import io.gamerope.wallet.dialog.SwapRiskDialog
import io.gamerope.wallet.feature.address.ScanActivity
import io.gamerope.wallet.feature.auth.AuthManager
import io.gamerope.wallet.support.*
import io.gamerope.wallet.support.extensions.*
import io.gamerope.wallet.widget.IOSDialog
import io.gamerope.wallet.widget.MaterialProgressDrawable
...
class SwapFragment : BaseFragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.balance.observe(this, Observer { value ->
            value?.let {
                clearFocus()
                balance.text = "${it.decimalFormat()} LOZZ"
            }
        })
        ...
        AppDatabase.getInstance().walletDao().loadActiveWallet().observe(this, Observer { wallet ->
            wallet?.let {
                walletId = it.id
                balance.text = "${it.balance.decimalFormat()} LOZZ"
