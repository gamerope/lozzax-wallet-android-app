package io.gamerope.wallet.support.extensions
...
import io.gamerope.wallet.data.remote.entity.RPCResponse
import io.gamerope.wallet.support.KEY_ALIAS
import io.gamerope.wallet.support.RSA_KEY_ALIAS
...
fun ImageView.setImage(coin: String) {
    when (coin.toUpperCase()) {
        "LOZZ" -> setImageResource(R.drawable.icon_xmr)
