...
class MarketViewModel : BaseViewModel() {
    ...
    private fun request(currency: String) {
        try {
            val url =
                "https://api.coingecko.com/api/v3/simple/price?ids=lozzax,monero,bitcoin,litecoin,ethereum,eos&vs_currencies=${currency}"
            ...
            if (connection.responseCode == HttpURLConnection.HTTP_OK) {
                ...
                val lozzax = json.optJSONObject("lozzax")
                val lozzaxPrice = lozzax.optString(currency)
